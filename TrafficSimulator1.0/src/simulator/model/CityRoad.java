...
public class CityRoad extends Road{
	...
	int calculateVehicleSpeed(Vehicle v) {
		//return (int) Math.ceil(((11.0 - v.getGradContam()) / 11.0) * actVelLimit); //TODO preguntar si el ceil se tiene que poner
		return (int) (((11.0 - v.getGradContam()) / 11.0) * actVelLimit); //TODO preguntar si el ceil se tiene que poner
